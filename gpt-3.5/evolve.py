...
class ChatGPTPipeline:
    def __init__(self):
        openai.api_key = os.getenv("OPENAI_API_KEY_GPT_3")
...
# CUDA_VISIBLE_DEVICES=3 python gpt-3.5/evolve.py --seed_file seed_data.json --column_names instruction input --num_rows 20
